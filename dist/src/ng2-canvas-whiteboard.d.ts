...
export { FreeHandShape } from "./shapes/free-hand-shape";
export { CircleShape } from "./shapes/circle-shape";
export { LineShape } from './shapes/line-shape';
export { RectangleShape } from "./shapes/rectangle-shape";
export { SmileyShape } from './shapes/smiley-shape';
export { StarShape } from './shapes/star-shape';
